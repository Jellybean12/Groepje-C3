...
def richtingscoefficient(pnt, dfmeting = 0):
    """___________"""
    # Wanneer de meting 0 is (geen meting mee gegeven), maak dan een connectie met de database en maak een dataframe met een query.
    if dfmeting == 0 :
    ...
    # Anders is df de meegegeven dataframe
    else :
        df = dfmeting
